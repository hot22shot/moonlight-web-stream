...
use moonlight_common_sys::limelight::{
    ...
    CAPABILITY_SUPPORTS_ARBITRARY_AUDIO_DURATION, COLOR_RANGE_FULL, COLOR_RANGE_LIMITED, DOWN_FLAG,
    ENCFLG_ALL, ENCFLG_AUDIO, ENCFLG_NONE, ENCFLG_VIDEO, KEY_ACTION_DOWN, KEY_ACTION_UP, LB_FLAG,
    LEFT_FLAG, LI_BATTERY_PERCENTAGE_UNKNOWN, LI_BATTERY_STATE_CHARGING,
    LI_BATTERY_STATE_DISCHARGING, LI_BATTERY_STATE_FULL, LI_BATTERY_STATE_NOT_CHARGING,
    LI_BATTERY_STATE_NOT_PRESENT, LI_BATTERY_STATE_UNKNOWN, LI_CCAP_ACCEL, LI_CCAP_ANALOG_TRIGGERS,
    LI_CCAP_BATTERY_STATE, LI_CCAP_GYRO, LI_CCAP_RGB_LED, LI_CCAP_RUMBLE, LI_CCAP_TOUCHPAD,
    LI_CCAP_TRIGGER_RUMBLE, LI_CTYPE_NINTENDO, LI_CTYPE_PS, LI_CTYPE_UNKNOWN, LI_CTYPE_XBOX,
    LI_ERR_UNSUPPORTED, LI_FF_CONTROLLER_TOUCH_EVENTS, LI_FF_PEN_TOUCH_EVENTS,
    LI_MOTION_TYPE_ACCEL, LI_MOTION_TYPE_GYRO, LI_ROT_UNKNOWN, LS_CLK_FLAG, LiGetEstimatedRttInfo,
    LiGetHostFeatureFlags, LiSendControllerArrivalEvent, LiSendControllerBatteryEvent,
    ...
    LiSendTouchEvent, LiSendUtf8TextEvent, LiStartConnection, LiStopConnection, MISC_FLAG,
    MODIFIER_ALT, MODIFIER_CTRL, MODIFIER_META, MODIFIER_SHIFT, PADDLE1_FLAG, PADDLE2_FLAG,
    PADDLE3_FLAG, PADDLE4_FLAG, PAUDIO_RENDERER_CALLBACKS, PCONNECTION_LISTENER_CALLBACKS,
...
#[derive(Debug, Clone, Copy, FromPrimitive)]
pub enum Colorspace {
    // Bincode doesn't like it when using consts
    Rec601 = 0,  // COLORSPACE_REC_601
    Rec709 = 1,  // COLORSPACE_REC_709
    Rec2020 = 2, // COLORSPACE_REC_2020
}
